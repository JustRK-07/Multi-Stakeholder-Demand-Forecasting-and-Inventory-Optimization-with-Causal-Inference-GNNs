...
def _sanitize_user(record: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "storeType": record.get("storeType"),
        "assignedModelId": record.get("assignedModelId"),
        "modelLastUpdated": record.get("modelLastUpdated"),
        "createdAt": record.get("createdAt"),
        "lastLoginAt": record.get("lastLoginAt"),
    }


def create_user(name: str, email: str, password: str, store_type: Optional[str] = None, assigned_model_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    users[normalized_email] = {
        ...
        "assignedModelId": assigned_model_id,
        "modelLastUpdated": now if assigned_model_id else None,
        "createdAt": now,
        "lastLoginAt": None,
    }
